...
install_packages() {
  info "Instalando pacotes para PostgreSQL e compilacao do Python..."
...
install_python() {
  ...
  info "Compilando Python $PYTHON_PATCH_VERSION em $PYTHON_PREFIX..."
...
main() {
  ...
  warn "Instalador focal-build: nao usa pacotes Python do APT; compila Python $PYTHON_PATCH_VERSION."
  install_packages
  install_python
  prepare_repository
  configure_env
